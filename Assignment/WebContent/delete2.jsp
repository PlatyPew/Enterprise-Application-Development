...
String[] delete = request.getParameterValues("delete1");
try
{
...
for(int i = 0; i < delete.length; i++) {
		query="DELETE FROM assignment.flightschedule WHERE flightid=?;";
...
if(z){
response.sendRedirect("updateanddelete.jsp?delete2=yes");
}else{
response.sendRedirect("updateanddelete.jsp?delete2=no");
}
